    ...
    <div className="min-h-screen bg-[#F5F5F0] text-[#333] font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-[#E0E0E0] shadow-sm h-16 flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
           <div className="flex items-center gap-2 bg-[#F5F5F0] px-3 py-1.5 rounded-full">
             ...
             <span className="text-sm font-bold text-stone-600">山田 健太</span>
           </div>
        </div>
      </header>
      ...
      <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="hidden lg:block lg:col-span-3 space-y-6">
          <div className="bg-white rounded-xl border border-[#E0E0E0] p-6 shadow-sm">
             <div className="text-center mb-4">
               ...
               <h2 className="font-bold text-lg">山田 健太</h2>
               <p className="text-sm text-stone-500">@kenta_ymd</p>
             </div>
             <div className="space-y-3 text-sm">
               <div className="flex items-center gap-3 p-2 bg-orange-50 rounded-lg text-orange-800 font-bold">
                 <Icons.School />
                 <span>那覇高校 (2015卒)</span>
               </div>
        ...
        <main className="lg:col-span-6 space-y-8">
          ...
          {/* 1. School Dashboard Card (The "Center" you wanted) */}
          <section className="bg-white rounded-2xl border border-[#E0E0E0] overflow-hidden shadow-sm">
            <div className="h-32 bg-[#2E6B52] relative">
              ...
              <div className="absolute bottom-4 left-6 text-white">
                ...
                <h1 className="text-3xl font-black tracking-tight">那覇高校</h1>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mb-6 flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-bold text-amber-900 mb-1">【重要】創立100周年記念式典について</h3>
                  <p className="text-sm text-amber-800 leading-relaxed">
                    来月開催される記念式典の出欠確認を行っています。OB・OGの皆様は詳細をご確認ください。
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-b border-[#E0E0E0] py-4 last:border-0">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="bg-blue-100 text-blue-700 text-xs font-bold px-2 py-0.5 rounded">野球部</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-stone-500 font-bold">宮城 健太 (2014卒)</span>
                ...
                <div className="border-b border-[#E0E0E0] py-4 last:border-0">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-0.5 rounded">2015年卒</span>
                    <span className="text-stone-400 text-xs">5時間前</span>
                  </div>
                  <p className="font-bold text-stone-800 mb-2 cursor-pointer hover:text-orange-600 transition">
                    3年2組のクラス会を企画しています。連絡先がわからない人がいるので拡散お願いします！
                  </p>
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-stone-200 overflow-hidden">
                       <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sora" alt="User" />
                    </div>
                    <span className="text-xs text-stone-500 font-bold">佐藤 美咲</span>
                    <div className="ml-auto flex gap-3 text-stone-400 text-xs font-bold">
                      <span className="flex items-center gap-1"><Icons.MessageCircle /> 18</span>
                      <span className="flex items-center gap-1"><Icons.Heart /> 45</span>
                    </div>
                  </div>
                </div>
          ...
          <section className="bg-white rounded-2xl border border-[#E0E0E0] p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-lg text-stone-800">野球部 部室</h2>
                  <p className="text-xs text-stone-500">メンバー 42人</p>
                </div>
              </div>
        ...
        <aside className="hidden lg:block lg:col-span-3 space-y-6">
          <div className="bg-white rounded-xl border border-[#E0E0E0] p-5 shadow-sm">
            <h3 className="font-bold text-stone-700 mb-4 flex items-center gap-2">
              <span className="text-orange-500">📍</span> 地元の話題
            </h3>
            <div className="space-y-4">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <div className="font-bold text-sm text-stone-800 hover:text-orange-600 cursor-pointer">国際通りの再開発について</div>
                  <div className="text-xs text-stone-400 mt-1">那覇市 • ニュース</div>
                </div>
              </div>
              <div className="flex gap-3 items-start">
                <div className="w-16 h-16 bg-stone-200 rounded-lg overflow-hidden flex-shrink-0">
                  <img src="https://images.unsplash.com/photo-1625723347040-0fdf78cb3c1e?q=80&w=800&auto=format&fit=crop" className="w-full h-full object-cover" />
                </div>
                <div>
                  <div className="font-bold text-sm text-stone-800 hover:text-orange-600 cursor-pointer">首里城復興イベント開催</div>
                  <div className="text-xs text-stone-400 mt-1">イベント • 今週末</div>
                </div>
              </div>
            </div>
          </div>
